...
*1)* Algoritmayı çalıştırabilmemiz için linux işletim sistemine ihtiyacımız vardır. Linux işletim sistemini sanal makine üzerinde çalışrırabiliriz. Linux işletim sistemini çalıştırabilmemzi için,

  1.a) link:+https://www.virtualbox.org/wiki/Downloads
